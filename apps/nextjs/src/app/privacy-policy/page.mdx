...
- **Google Account Information**: When you log in using your Google account, we collect your Google ID, email address, and profile information including your name and profile photo. We use this data to personalize your experience, greeting you by name and displaying your profile photo in the App.
...
- To personalize your app experience by using your name and profile photo from your Apple/Google account.
